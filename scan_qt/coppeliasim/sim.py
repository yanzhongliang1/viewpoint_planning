...
import os
import ctypes as ct
from scan_qt.coppeliasim.simConst import *
...
c_GetArrayParam = ct.CFUNCTYPE(ct.c_int32, ct.c_int32, ct.c_int32, ct.POINTER(ct.c_float), ct.c_int32)(
    ("simxGetArrayParam", libsimx))
c_SetArrayParam = ct.CFUNCTYPE(ct.c_int32, ct.c_int32, ct.c_int32, ct.POINTER(ct.c_float), ct.c_int32)(
    ("simxSetArrayParam", libsimx))
c_GetBoolParam = ct.CFUNCTYPE(ct.c_int32, ct.c_int32, ct.c_int32, ct.POINTER(ct.c_ubyte), ct.c_int32)(
...
c_GetInt32Param = ct.CFUNCTYPE(ct.c_int32, ct.c_int32, ct.c_int32, ct.POINTER(ct.c_int32), ct.c_int32)(
    ("simxGetInt32Param", libsimx))
c_SetInt32Param = ct.CFUNCTYPE(ct.c_int32, ct.c_int32, ct.c_int32, ct.c_int32, ct.c_int32)(
    ("simxSetInt32Param", libsimx))
c_GetFloatParam = ct.CFUNCTYPE(ct.c_int32, ct.c_int32, ct.c_int32, ct.POINTER(ct.c_float), ct.c_int32)(
    ("simxGetFloatParam", libsimx))
c_SetFloatParam = ct.CFUNCTYPE(ct.c_int32, ct.c_int32, ct.c_int32, ct.c_float, ct.c_int32)(
    ("simxSetFloatParam", libsimx))
c_GetStringParam = ct.CFUNCTYPE(ct.c_int32, ct.c_int32, ct.c_int32, ct.POINTER(ct.POINTER(ct.c_char)), ct.c_int32)(
...
c_CheckCollision = ct.CFUNCTYPE(ct.c_int32, ct.c_int32, ct.c_int32, ct.c_int32, ct.POINTER(ct.c_ubyte), ct.c_int32)(
    ("simxCheckCollision", libsimx))
c_CheckDistance = ct.CFUNCTYPE(ct.c_int32, ct.c_int32, ct.c_int32, ct.c_int32, ct.POINTER(ct.c_float), ct.c_int32)(
...
c_ClearInt32Signal = ct.CFUNCTYPE(ct.c_int32, ct.c_int32, ct.POINTER(ct.c_char), ct.c_int32)(
...
c_GetInt32Signal = ct.CFUNCTYPE(ct.c_int32, ct.c_int32, ct.POINTER(ct.c_char), ct.POINTER(ct.c_int32), ct.c_int32)(
...
c_SetInt32Signal = ct.CFUNCTYPE(ct.c_int32, ct.c_int32, ct.POINTER(ct.c_char), ct.c_int32, ct.c_int32)(
...
c_GetObjectFloatParam = ct.CFUNCTYPE(ct.c_int32, ct.c_int32, ct.c_int32, ct.c_int32, ct.POINTER(ct.c_float),
                                     ct.c_int32)(("simxGetObjectFloatParam", libsimx))
c_SetObjectFloatParam = ct.CFUNCTYPE(ct.c_int32, ct.c_int32, ct.c_int32, ct.c_int32, ct.c_float, ct.c_int32)(
    ("simxSetObjectFloatParam", libsimx))
c_GetObjectInt32Param = ct.CFUNCTYPE(ct.c_int32, ct.c_int32, ct.c_int32, ct.c_int32, ct.POINTER(ct.c_int32),
                                     ct.c_int32)(("simxGetObjectInt32Param", libsimx))
c_SetObjectInt32Param = ct.CFUNCTYPE(ct.c_int32, ct.c_int32, ct.c_int32, ct.c_int32, ct.c_int32, ct.c_int32)(
...
def simxCheckCollision(clientID, entity1, entity2, operationMode):
    ...
    '''
    collisionState = ct.c_ubyte()
    return c_CheckCollision(clientID, entity1, entity2, ct.byref(collisionState), operationMode), bool(
        collisionState.value != 0)
...
def simxGetObjectFloatParam(clientID, objectHandle, parameterID, operationMode):
    ...
    return c_GetObjectFloatParam(clientID, objectHandle, parameterID, ct.byref(parameterValue),
...
def simxGetObjectInt32Param(clientID, objectHandle, parameterID, operationMode):
    ...
    return c_GetObjectInt32Param(clientID, objectHandle, parameterID, ct.byref(parameterValue),
                                 operationMode), parameterValue.value
